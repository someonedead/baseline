...
class ArcModule(nn.Module):
    ...
    def forward(self, inputs, labels):
        ...
        cos_th_m = torch.where(cos_th > self.th, cos_th_m, cos_th - self.mm).to(torch.float32)
...
class WhalesNet(nn.Module):
    ...
    def __init__(self, channel_size, out_feature, dropout=0.2, backbone='densenet161', pretrained=True, s=15, m=0.5):
        super().__init__()
        self.s = s
        self.m = m
